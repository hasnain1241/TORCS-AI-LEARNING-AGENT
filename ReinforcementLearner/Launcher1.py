...
def drive_example(c):
    ...
    # Hardcoded Gear Shifting Based on RPM
    if S['rpm'] > 6500:  # Shift up if RPM exceeds 9000
        R['gear'] = min(R['gear'] + 1, 6)  # Max gear is 6
    elif S['rpm'] < 3000 and R['gear'] > 1:  # Shift down if RPM drops below 3000
        R['gear'] = max(R['gear'] - 1, 1)  # Min gear is 1
